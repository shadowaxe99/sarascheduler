...
class AlchemyAPI:
    ...
    def entities(self, flavor, data, options={}):
        ...
        if flavor not in AlchemyAPI.ENDPOINTS["entities"]:
            return {
                "status": "ERROR",
                "statusInfo": "entity extraction for " + flavor + " not available",
            }
    ...
    def keywords(self, flavor, data, options={}):
        ...
        if flavor not in AlchemyAPI.ENDPOINTS["keywords"]:
            return {
                "status": "ERROR",
                "statusInfo": "keyword extraction for " + flavor + " not available",
            }
    ...
    def concepts(self, flavor, data, options={}):
        ...
        if flavor not in AlchemyAPI.ENDPOINTS["concepts"]:
            return {
                "status": "ERROR",
                "statusInfo": "concept tagging for " + flavor + " not available",
            }
    ...
    def sentiment(self, flavor, data, options={}):
        ...
        if flavor not in AlchemyAPI.ENDPOINTS["sentiment"]:
            return {
                "status": "ERROR",
                "statusInfo": "sentiment analysis for " + flavor + " not available",
            }
    ...
    def sentiment_targeted(self, flavor, data, target, options={}):
        ...
        if target is None or target == "":
            return {
                "status": "ERROR",
                "statusInfo": "targeted sentiment requires a non-null target",
            }
        ...
        if flavor not in AlchemyAPI.ENDPOINTS["sentiment_targeted"]:
            return {
                "status": "ERROR",
                "statusInfo": "targeted sentiment analysis for "
                + flavor
                + " not available",
            }
    ...
    def text(self, flavor, data, options={}):
        ...
        if flavor not in AlchemyAPI.ENDPOINTS["text"]:
            return {
                "status": "ERROR",
                "statusInfo": "clean text extraction for " + flavor + " not available",
            }
    ...
    def text_raw(self, flavor, data, options={}):
        ...
        if flavor not in AlchemyAPI.ENDPOINTS["text_raw"]:
            return {
                "status": "ERROR",
                "statusInfo": "raw text extraction for " + flavor + " not available",
            }
    ...
    def author(self, flavor, data, options={}):
        ...
        if flavor not in AlchemyAPI.ENDPOINTS["author"]:
            return {
                "status": "ERROR",
                "statusInfo": "author extraction for " + flavor + " not available",
            }
    ...
    def language(self, flavor, data, options={}):
        ...
        if flavor not in AlchemyAPI.ENDPOINTS["language"]:
            return {
                "status": "ERROR",
                "statusInfo": "language detection for " + flavor + " not available",
            }
    ...
    def title(self, flavor, data, options={}):
        ...
        if flavor not in AlchemyAPI.ENDPOINTS["title"]:
            return {
                "status": "ERROR",
                "statusInfo": "title extraction for " + flavor + " not available",
            }
    ...
    def relations(self, flavor, data, options={}):
        ...
        if flavor not in AlchemyAPI.ENDPOINTS["relations"]:
            return {
                "status": "ERROR",
                "statusInfo": "relation extraction for " + flavor + " not available",
            }
    ...
    def category(self, flavor, data, options={}):
        ...
        if flavor not in AlchemyAPI.ENDPOINTS["category"]:
            return {
                "status": "ERROR",
                "statusInfo": "text categorization for " + flavor + " not available",
            }
    ...
    def feeds(self, flavor, data, options={}):
        ...
        if flavor not in AlchemyAPI.ENDPOINTS["feeds"]:
            return {
                "status": "ERROR",
                "statusInfo": "feed detection for " + flavor + " not available",
            }
    ...
    def microformats(self, flavor, data, options={}):
        ...
        if flavor not in AlchemyAPI.ENDPOINTS["microformats"]:
            return {
                "status": "ERROR",
                "statusInfo": "microformat extraction for " + flavor + " not available",
            }
    ...
    def imageExtraction(self, flavor, data, options={}):
        ...
        if flavor not in AlchemyAPI.ENDPOINTS["image"]:
            return {
                "status": "ERROR",
                "statusInfo": "image extraction for " + flavor + " not available",
            }
        options[flavor] = data
    ...
    def taxonomy(self, flavor, data, options={}):
        ...
        if flavor not in AlchemyAPI.ENDPOINTS["taxonomy"]:
            return {
                "status": "ERROR",
                "statusInfo": "taxonomy for " + flavor + " not available",
            }
        options[flavor] = data
    ...
    def combined(self, flavor, data, options={}):
        ...
        if flavor not in AlchemyAPI.ENDPOINTS["combined"]:
            return {
                "status": "ERROR",
                "statusInfo": "combined for " + flavor + " not available",
            }
        options[flavor] = data
    ...
    def imageTagging(self, flavor, data, options={}):
        ...
        if flavor not in AlchemyAPI.ENDPOINTS["imagetagging"]:
            return {
                "status": "ERROR",
                "statusInfo": "imagetagging for " + flavor + " not available",
            }
        elif "image" == flavor:
            image = open(data, "rb").read()
            options["imagePostMode"] = "raw"
            return self.__analyze(
                AlchemyAPI.ENDPOINTS["imagetagging"][flavor], options, image
            )
    ...
    def faceTagging(self, flavor, data, options={}):
        ...
        if flavor not in AlchemyAPI.ENDPOINTS["facetagging"]:
            return {
                "status": "ERROR",
                "statusInfo": "facetagging for " + flavor + " not available",
            }
        elif "image" == flavor:
            image = open(data, "rb").read()
            options["imagePostMode"] = "raw"
            return self.__analyze(
                AlchemyAPI.ENDPOINTS["facetagging"][flavor], options, image
            )
    ...
    def __analyze(self, endpoint, params, post_data=bytearray()):
        ...
        try:
            post_url = (
                AlchemyAPI.BASE_URL + endpoint + "?" + urlencode(params).encode("utf-8")
            )
        except TypeError:
